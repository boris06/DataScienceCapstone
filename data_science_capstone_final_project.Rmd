...
In this section we describe all the steps of the methodology which we apply, whereas the associated program code can be found on GitHub (). 
...
df1 <- fasst(fA1)
print(xtable(cbind(df5,df1), align = c(rep("|l",9),"||l|",rep("l|",7)), 
                   caption="Correlations between four most frequent words and other words for five stars  (left) and one star reviews (right).",
                   label = "tab:assoc"), include.rownames=FALSE, 
